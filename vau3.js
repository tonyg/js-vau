...
Vau.KPrimitiveApplier.prototype.acceptsUnsafeArgument = function (a) {
    return true;
};
...
Vau.KEvalArgs.prototype.invoke = function (vm) {
    if (typeof vm.a === "object" && vm.a !== null
	&& vm.a.isUnsafe && vm.a.isUnsafe()
	&& !this.k.acceptsUnsafeArgument(vm.a))
    {
	throw {message: "Attempt to transmit unsafe object to receiver",
	       object: vm.a};
    }
...
Vau.Operative.prototype.isUnsafe = function () {
    return true;
};
...
Vau.KApplicativeApplier.prototype.acceptsUnsafeArgument = function (a) {
    return false;
};
...
Vau.Primitive.prototype.isUnsafe = function () {
    return true;
};
